                ...
                <div className="grid lg:grid-cols-5 gap-12 items-center">
                    ...
                    <div className="lg:col-span-3">
                        ...
                        <div className="relative mb-6">
                            ...
                            {/* Front face */}
                            <h1 className="relative text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight leading-[1.05]">
                                <span className="text-gradient-gb">SOUTH INDIA</span>
                                <br/> <span className="text-visionaries">
                                VISIONARIES </span>
                                <br/>
                                <span className="text-gradient-gb">
                                    SUMMIT & AWARDS
                                </span>
                                <br/>
                                <span className="text-gradient-gb">2026</span>
                            </h1>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row items-start gap-4 mb-12">
                            <a href="#pricing" className="group flex items-center gap-2.5 px-8 py-4 text-base font-bold text-white bg-gradient-to-r from-gb-500 to-gb-600 hover:from-gb-400 hover:to-gb-500 rounded-xl transition-all duration-300 gold-shadow hover:scale-[1.02]">
                                <Ticket className="w-5 h-5"/>
                                Register for Summit
                                <span className="group-hover:translate-x-1 transition-transform">→</span>
                            </a>
                            <a href="#contact" className="group flex items-center gap-2.5 px-8 py-4 text-base font-medium text-white border border-white/20 hover:border-white/40 hover:bg-white/10 rounded-xl transition-all duration-300 backdrop-blur-sm">
                                <Trophy className="w-5 h-5 text-gb-600"/>
                                Nominate for Awards
                            </a>
                        </div>
                        ...
                        <div className="flex items-center gap-6">
                            <div className="flex -space-x-2.5">
                                ...
                                DELEGATE_AVATARS.map((seed) => (
                                    <img key={seed}
                                        src={
                                            `https://picsum.photos/seed/${seed}/48/48.jpg`
                                        }
